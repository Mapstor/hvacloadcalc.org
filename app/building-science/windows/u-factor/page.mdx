...
export const metadata = {
  alternates: { canonical: "/building-science/windows/u-factor/" },
...
<ArticleHeader
  h1="Window U-Factor Explained"
  description="Window U-factor — what it measures, how to read the NFRC label, U-factor ranges by frame type and glazing, ENERGY STAR thresholds by climate zone.'s what U-factor means, how it relates to R-value, and what to look for."
...
Federal tax credits: the §25C Energy Efficient Home Improvement Credit (active 2023 through December 31, 2025) returned 30% of qualified ENERGY STAR Most Efficient window costs, capped at $600/year for windows, for installs completed within that window. §25C is not available for 2026 installs under current IRS guidance — verify the IRS Energy Efficient Home Improvement Credit page before assuming any specific 2026 credit amount.
