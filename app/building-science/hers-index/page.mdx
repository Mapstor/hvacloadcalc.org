...
export const metadata = {
  alternates: { canonical: "/building-science/hers-index/" },
...
export const SOURCES = [
  ...
  {
    id: 'irs-25c-179d',
    title: 'Energy Efficient Home Improvement Credit (Section 25C — see FS-2025-05; HVAC scope expired Dec 31, 2025) and New Energy Efficient Home Credit (Section 45L)',
...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Yes, in specific contexts. The 45L New Energy Efficient Home Credit (up to $5,000 per unit) requires HERS-based certification at specific thresholds. The §25C Energy Efficient Home Improvement Credit didn't directly use HERS but used equipment efficiency criteria that contribute to lower HERS scores; note that §25C HVAC/envelope scope expired December 31, 2025 under the One Big Beautiful Bill Act (verify current IRS guidance). State and utility programs often tie incentives to specific HERS thresholds and remain administered independent of federal program changes.",
  },
  {
...
The §25C Energy Efficient Home Improvement Credit (existing homes) returned up to $3,200/year combined for installs completed by December 31, 2025; the §25C HVAC scope expired after that date under the One Big Beautiful Bill Act. The credit didn't directly use HERS but used equipment efficiency criteria that contribute to lower HERS scores. See [IRS Energy Efficient Home Improvement Credit](https://www.irs.gov/credits-deductions/energy-efficient-home-improvement-credit) for current 2026 specifics.
