...
export const metadata = {
  alternates: { canonical: "/building-science/insulation/attic-r-value/" },
...
<ArticleHeader
  h1="Attic R-Value Explained"
  description="DOE recommended attic R-values by IECC climate zone (R-30 in warm climates to R-60 in cold), R-per-inch by material, payback analysis, and air sealing primacy.ates. Here's what the numbers mean and how to verify what you actually have."
...
Utility rebates further shorten payback. The federal §25C Energy Efficient Home Improvement Credit covered up to 30% of qualified envelope improvements capped at $1,200/year for installs completed on or before December 31, 2025; §25C is not available for 2026 installs under current IRS guidance — verify the IRS page. Many state and utility programs add rebates ranging from $500-$2,000 per attic insulation project and remain administered independent of federal program changes.
