...
<DataTable
  ...
  rows={[
    ...
    },
    {
      ...
      does: 'Documentation of historical and current §25C, HEEHRA, HOMES program structures and qualifying equipment thresholds (note: §25C HVAC scope expired Dec 31, 2025; see IRS for current 2026 status)',
