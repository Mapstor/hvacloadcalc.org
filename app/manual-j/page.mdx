...
<JsonLdLearningResource
  resource={{
    name: 'Manual J Load Calculation Methodology',
    description: 'ACCA Manual J 8th Edition residential load calculation methodology — Heat Transfer Multipliers, infiltration, internal gains, workflow.',
    url: '/manual-j/',
    about: 'ACCA Manual J 8th Edition residential heating and cooling load calculation',
